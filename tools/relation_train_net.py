...
def train(cfg, logger, args):
    ...
    if args['use_wandb']:
        ...
        if args['distributed']:
            wandb.init(project="sgg-indoorvg-4", entity="maelic", group="DDP", name=run_name, config=cfg)
        wandb.init(project="sgg-indoorvg-4", entity="maelic", name=run_name, config=cfg)
