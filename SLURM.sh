...
# for motifs
#srun python -m torch.distributed.launch --master_port 10026 --nproc_per_node=2 tools/relation_train_net.py --use-wandb --config-file "configs/VG178/e2e_relation_X_101_32_8_FPN_1x.yaml" MODEL.ROI_RELATION_HEAD.USE_GT_BOX False MODEL.ROI_RELATION_HEAD.USE_GT_OBJECT_LABEL False MODEL.ROI_RELATION_HEAD.PREDICTOR CausalAnalysisPredictor MODEL.ROI_RELATION_HEAD.CAUSAL.EFFECT_TYPE TDE MODEL.ROI_RELATION_HEAD.CAUSAL.FUSION_TYPE sum MODEL.ROI_RELATION_HEAD.CAUSAL.CONTEXT_LAYER motifs MODEL.ROI_RELATION_HEAD.CONTEXT_HIDDEN_DIM 512 SOLVER.IMS_PER_BATCH 24 TEST.IMS_PER_BATCH 2 DTYPE "float16" SOLVER.MAX_ITER 50000 SOLVER.VAL_PERIOD 2000 SOLVER.CHECKPOINT_PERIOD 4000 SOLVER.BASE_LR 0.02 SOLVER.PRE_VAL False GLOVE_DIR /gpfswork/rech/gtb/ukj95zg/glove MODEL.PRETRAINED_DETECTOR_CKPT /gpfswork/rech/gtb/ukj95zg/Scene-Graph-Benchmark-Cuda11.7/checkpoints/faster_rcnn/best_model_0058000.pth OUTPUT_DIR /gpfswork/rech/gtb/ukj95zg/Scene-Graph-Benchmark-Cuda11.7/checkpoints/VG178/motifs

# for transformer
srun python -m torch.distributed.launch --master_port 10026 --nproc_per_node=2 tools/relation_train_net.py --use-wandb --config-file "configs/VG178/e2e_relation_X_101_32_8_FPN_1x.yaml" MODEL.ROI_RELATION_HEAD.USE_GT_BOX False MODEL.ROI_RELATION_HEAD.USE_GT_OBJECT_LABEL False MODEL.ROI_RELATION_HEAD.PREDICTOR TransformerPredictor SOLVER.SCHEDULE.TYPE WarmupMultiStepLR SOLVER.IMS_PER_BATCH 24 TEST.IMS_PER_BATCH 2 DTYPE "float16" SOLVER.MAX_ITER 16000 SOLVER.STEPS "(10000, 16000)" SOLVER.VAL_PERIOD 2000 SOLVER.CHECKPOINT_PERIOD 2000 SOLVER.BASE_LR 0.01 SOLVER.PRE_VAL False GLOVE_DIR /gpfswork/rech/gtb/ukj95zg/glove MODEL.PRETRAINED_DETECTOR_CKPT /gpfswork/rech/gtb/ukj95zg/Scene-Graph-Benchmark-Cuda11.7/checkpoints/faster_rcnn/best_model_0058000.pth OUTPUT_DIR /gpfswork/rech/gtb/ukj95zg/Scene-Graph-Benchmark-Cuda11.7/checkpoints/VG178/transformer
